                    ...
                    <div className="w-64 bg-white shadow-sm hidden md:block">
                        ...
                        >
                            <div className="text-center">
                                ...
                                <div
                                    className={`text-sm font-medium ${activeSection === "general" ? "text-white" : "text-gray-700"}`}
                                >
                                    General Questions
                                </div>
                            </div>
                        ...
                        >
                            <div className="flex flex-col items-center text-center">
                                <div
                                    className={`w-12 h-12 rounded-full flex items-center justify-center mb-3 ${activeSection === "privacy" ? "border-2 border-white" : "border-2 border-gray-300"}`}
                                >
                                    <ShieldCheck
                                        size={24}
                                        className={
                                ...
                                <div
                                    className={`text-sm font-medium ${activeSection === "privacy" ? "text-white" : "text-gray-700"}`}
                                >
                                    Privacy Policy
                                </div>
                            </div>
                        ...
                        >
                            <div className="flex flex-col items-center text-center">
                                <div
                                    className={`w-12 h-12 rounded-full flex items-center justify-center mb-3 ${activeSection === "support" ? "bg-blue-500" : "bg-gray-100"}`}
                                >
                                    <LifeBuoy
                                        size={24}
                                        className={
                                ...
                                <div
                                    className={`text-sm font-medium ${activeSection === "support" ? "text-white" : "text-gray-700"}`}
                                >
                                    Support
                                </div>
                            </div>
